# -*- coding: utf-8 -*-
"""重跑：event-balanced + auto-threshold + min-active-bins=2，输出 experiment_06。"""
import subprocess, sys, time
from pathlib import Path

REPO = Path(r"G:\1A岩爆预测\sundial-rockburst")
OUT = Path(r"G:\1A岩爆预测\sundial-rockburst\artifacts\experiment_06_auto_thr")
GUARD = REPO / "guard_abl6.log"
RUN_LOG = REPO / "train_run9.log"
ERR_LOG = REPO / "train_err9.log"
