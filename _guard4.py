# -*- coding: utf-8 -*-
"""重跑消融（新代码：threshold_sweep + recommended_variant），输出 experiment_04。"""
import subprocess, sys, time
from pathlib import Path

REPO = Path(r"G:\1A岩爆预测\sundial-rockburst")
OUT = Path(r"G:\1A岩爆预测\sundial-rockburst\artifacts\experiment_04_transient_abl")
GUARD = REPO / "guard_abl4.log"
RUN_LOG = REPO / "train_run7.log"
ERR_LOG = REPO / "train_err7.log"
